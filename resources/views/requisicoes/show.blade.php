            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-base-100 shadow-xl rounded-3xl p-8">
                        ...
                        <!-- Botão de Review (apenas para cidadãos, quando a requisição está entregue) -->
                        @if(!auth()->user()->isAdmin() && $requisicao->status == 'entregue')
                            @if(!$requisicao->hasReview())
                                <div class="mt-4">
                                    <a href="{{ route('reviews.create', $requisicao) }}" class="btn btn-primary btn-block">
                            ...
                            @else
                                <div class="mt-4 alert alert-success">
                                    ...
                                    <span>Já submeteu uma review para este livro. Aguarde moderação.</span>
                                </div>
                            @endif
                        @endif
                    </div>
